...
func (a *App) showCheckUpdate() {
	...
	if err := (Dialog{
		...
		Children: []Widget{
			dlgBody(Label{AssignTo: &status, Text: i18n.T(i18n.KeyCheckUpdateChecking)}),
...
func (a *App) showCloudSync() {
	...
	_, _ = Dialog{
		...
		Children: []Widget{
			dlgBody(
				Label{Text: i18n.T(i18n.KeyCloudSyncConfigSection), Font: uiFontBold()},
				...
				Label{Text: i18n.T(i18n.KeyCloudSyncStatusSection), Font: uiFontBold()},
				...
				Label{Text: i18n.T(i18n.KeyCloudSyncActionSection), Font: uiFontBold()},
				Composite{
					Layout: HBox{},
					Children: []Widget{
			...
			dlgFooter(PushButton{Text: i18n.T(i18n.KeyOK), OnClicked: func() {
				saveLocalConfig()
				dlg.Cancel()
			}}),
		},
